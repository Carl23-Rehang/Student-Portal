          ...
          <div class="container-fluid" style="padding-left: 10px;padding-right: 10px;">
            ...
            <div class="row">
              ...
              <?php
                ...
                //echo $log_userid;
                $result = pg_query($pgconn, "SELECT sy,sem from srgb.ass_details where UPPER(TRIM(studid))='" . strtoupper(trim($log_userid)) . "' group by sy,sem order by sy DESC, sem ASC");
                //echo $log_userid;
                if ($result) {
                  //echo "XXX";
                  $sy = "";
                  ...
                  while ($row = pg_fetch_array($result)) {
                    ...
                    $tc = $tc . '
                        <tr style="font-size: 0.7rem;">
                          ...
                          <td>' . $tsy . '</td>
                          <td>' . $tsem . '</td>
                          <td><a href="' . $tlink . '">' . number_format($tass, 2) . '</a></td>
                          <td><a href="' . $tlink . '">' . number_format($tpaid, 2). '</a></td>
                        </tr>
                    ';
                    //
                    //
