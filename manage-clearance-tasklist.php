<?php session_start(); include "connect.php"; //error_reporting(0);
  ...
  if(trim($log_userid)!="") {
    if($_POST['btnadd']) {
      ...
      $query0 = "SELECT * FROM tbl_clearance_tasklist where LOWER(TRIM(taskname))==LOWER(TRIM('" . $name . "'))";
      ...
      if($errn <= 0) {
        ...
        $query = "INSERT INTO tbl_clearance_tasklist (taskname,details,addedby) VALUES ('" . $name . "','" . $description . "','" . trim($log_userid) . "') ";
    ...
    if($_POST['btnupdate']) {
      ...
      if($errn <= 0) {
        ...
        $query = "UPDATE tbl_clearance_tasklist set taskname='" . $name . "',details='" . $description . "' WHERE tasklistid='" . $id . "' ";
        $result = mysqli_query($conn,$query);
        //echo $result;
        //
        $dr = '
    ...
    if($_POST['btndelete']) {
      ...
      if($errn <= 0) {
        //echo $group . "  ". $description;
        $query = "DELETE FROM tbl_clearance_tasklist  WHERE tasklistid='" . $id . "' ";
        $result = mysqli_query($conn,$query);
        //echo $result;
        //
        $dr = '
                          ...
                          <div class="col-sm-6" style="padding-left: 4px;padding-right: 4px;">
                            ...
                            <div class="card shadow mb-4">
                              <div class="card-header py-3">
                                <div align="left">
                                  <h6 class="m-0 font-weight-bold text-primary" style="font-size: 0.7rem;"><span class="color-blue-1">Task List</span></h6>
                                </div>
                              </div>
                              <div class="card-body" style="padding-left: 4px;padding-right: 4px;">
                                      ...
                                      <div class="modal-body" style="font-size: 0.7rem;">
                                        <div align="left">
                                          ...
                                          <div class="form-group" >
                                            ...
                                            <input type="text" class="form-control form-control-user  input-text-value font-size-o-1"  name="name" id="name" placeholder="Task Name" value="" required>
                                          </div>
                                ...
                                <tbody class="font-size-o-1">
                                  <?php
                                    ...
                                    $query = "SELECT * FROM tbl_clearance_tasklist ORDER BY entrydate DESC";
                                    $result = mysqli_query($conn, $query);
                                    if ($result) {
                                      $n = 0;
                                                ...
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body" style="font-size: 0.7rem;">
                                                    <div align="left">
                                                      ...
                                                      <input type="hidden" name="id" value="' . trim($row['tasklistid']) . '" hidden />

                                                      <div class="form-group">
                                                        <span class="label1">Task: <span class="text-danger"></span></span>
                                                        <input type="text" class="form-control form-control-user  input-text-value font-size-o-1" name="name" id="name" placeholder="Task Name" value="' . trim($row['taskname']) . '" required>
                                                      </div>
