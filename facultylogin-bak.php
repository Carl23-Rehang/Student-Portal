<?php session_start(); include "connect.php"; //error_reporting(0);
  ...
  if($_POST['btnlogin'] && trim($user) != "") {
    ...
    if( $inmdb <= 0 ) {
      //CHECK IN EMPLOYEE
      $sresult = pg_query($pgconn, "SELECT * from pis.employee where LOWER(TRIM(empid))='" . strtolower(trim($user)) . "' ");
      //echo $sresult . $pgconn . $user;
      //echo pg_result_error($sresult);
      //echo "XX2";
      if ($sresult) {
        //echo 'GG ' . $user;
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post">
                    <div class="form-group">
                      <input type="text" class="c-input-3" id="username" name="username" aria-describedby="username" placeholder="Username / Employee ID / DSSC E-mail" required  
                        <?php
